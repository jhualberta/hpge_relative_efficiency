...
#
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 != X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 ] ; then
    G4INSTALL="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/src/geant4"
else
    G4INSTALL="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xy != Xn ] ; then 
    if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 != X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 ] ; then
        G4INCLUDE="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/include/geant4"
    else
        G4INCLUDE="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/include/"
    fi
    export G4INCLUDE
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/lib != X ] ; then 
    if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 != X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01 ] ; then
        G4LIB="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/lib/geant4"
    else
        G4LIB="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/lib"
    fi
    export G4LIB
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/PhotonEvaporation2.1 != X ] ; then 
    G4LEVELGAMMADATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/PhotonEvaporation2.1"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/RadioactiveDecay3.3 != X ] ; then 
    G4RADIOACTIVEDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/RadioactiveDecay3.3"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4EMLOW6.19 != X ] ; then 
    G4LEDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4EMLOW6.19"
    export G4LEDATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4NDL3.14 != X ] ; then 
    G4NEUTRONHPDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4NDL3.14"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4ABLA3.0 != X ] ; then 
    G4ABLADATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4ABLA3.0"
    export G4ABLADATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/RealSurface1.0 != X ] ; then 
    G4REALSURFACEDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/RealSurface1.0"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4NEUTRONXS1.0 != X ] ; then 
    G4NEUTRONXSDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4NEUTRONXS1.0"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4PII1.2 != X ] ; then 
    G4PIIDATA="/hepusers/ckrauss/work/snop/snocave/libraries/geant4.9.4.p01/data/G4PII1.2"
    export G4PIIDATA
    if [ X$g4non_display = X ] ; then
...
# g4clhep.U
#
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1 != X ] ; then 
    CLHEP_BASE_DIR="/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1/include != X ] ; then 
    CLHEP_INCLUDE_DIR="/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1/include"
...
#+
if [ X/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1/lib != X ] ; then 
    CLHEP_LIB_DIR="/hepusers/ckrauss/work/snop/snocave/libraries/clhep-2.1.0.1/lib"
...
if [ Xy = Xy ] ; then
    XERCESCROOT=/hepusers/ckrauss/work/snop/snocave/libraries/xerces-c-3.1.1
    export XERCESCROOT
    if test "x$g4non_display" = "x" ; then
